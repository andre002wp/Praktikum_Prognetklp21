...
} elseif ($_instance->childHasBeenRendered('yL5W7Ln')) {
    $componentId = $_instance->getRenderedChildComponentId('yL5W7Ln');
    $componentTag = $_instance->getRenderedChildComponentTagName('yL5W7Ln');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('yL5W7Ln');
} else {
    $response = \Livewire\Livewire::mount('admin.product.index');
    $html = $response->html();
    $_instance->logRenderedChild('yL5W7Ln', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?> 
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\asus\Desktop\Praktikum_project\resources\views/admin/product/index.blade.php ENDPATH**/ ?>