...
unset($__errorArgs, $__bag); ?> -->
            ...
            <h4>Image</h4>
            <div class="input-group mb-3">
                <input type="file" wire:model="image_name" class="form-control file"  data-browse-on-zone-click="true" required>
            </div>
            </div>
...
<?php /**PATH C:\xampp7\htdocs\Praktikum_project\resources\views/livewire/admin/product/create.blade.php ENDPATH**/ ?>