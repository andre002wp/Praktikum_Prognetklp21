...
} elseif ($_instance->childHasBeenRendered('0sx6T8b')) {
    $componentId = $_instance->getRenderedChildComponentId('0sx6T8b');
    $componentTag = $_instance->getRenderedChildComponentTagName('0sx6T8b');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('0sx6T8b');
} else {
    $response = \Livewire\Livewire::mount('admin.product.create');
    $html = $response->html();
    $_instance->logRenderedChild('0sx6T8b', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\asus\Desktop\Praktikum_project\resources\views/admin/product/add.blade.php ENDPATH**/ ?>