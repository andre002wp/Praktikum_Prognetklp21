...
} elseif ($_instance->childHasBeenRendered('TtsrTBz')) {
    $componentId = $_instance->getRenderedChildComponentId('TtsrTBz');
    $componentTag = $_instance->getRenderedChildComponentTagName('TtsrTBz');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('TtsrTBz');
} else {
    $response = \Livewire\Livewire::mount('admin.product.index');
    $html = $response->html();
    $_instance->logRenderedChild('TtsrTBz', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?> 
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\asus\OneDrive\Dokumen\GitHub\Praktikum_Prognetklp21\Praktikum_project\resources\views/admin/product/index.blade.php ENDPATH**/ ?>