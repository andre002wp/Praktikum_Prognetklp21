                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- form start -->
                            @livewire('admin.product.update',['id' => $products->id])
                                    ...
                                    {{ csrf_field() }}
                                        <div class="card-body">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" wire:model="product_name" class="form-control @error('product_name') is invalid @enderror" placeholder="{{$products->id}}">
                                            </div>
                                            @error('product_name')
